...
const AUTH_STEPS: TutorialStep[] = [
  ...
  },
  {
    icon: BookOpen,
    title: '每关先看教学',
    body: '课程不会一上来塞答案。小助理会先讲这关解决什么、脑内模型是什么、最容易错在哪里，然后编辑器才出现。',
  ...
  },
  {
    icon: MessageCircle,
    title: '卡住就叫小助理',
    body: '小助理会读取当前课程、代码、报错和你的提问。你可以打字，也可以用语音输入把问题说出来。',
    checkpoints: ['点击右下角 Q 版小助理', '选择“观察当前代码”', '用麦克风把问题填进对话框'],
  },
  {
    icon: Settings2,
    title: '把工作台调顺手',
    body: '命令中心可以调代号、小助理人格、字体、聊天面板宽度、活人感和课程显示方式。先让界面适合你，再长期学。',
...
const GUEST_STEPS: TutorialStep[] = [
  {
    icon: Play,
    title: '先试玩，不先注册',
    body: '游客模式能浏览课程、进入第一课、运行代码和体验小助理。本质限制只有一个：未登录不能保存跨设备进度。',
  ...
  },
  {
    icon: Sparkles,
    title: '登录后才有完整记忆',
    body: '正式账号会保存进度、设置、小助理偏好和长期学习上下文。试玩助手只给本地提示，不会替你保存。',
